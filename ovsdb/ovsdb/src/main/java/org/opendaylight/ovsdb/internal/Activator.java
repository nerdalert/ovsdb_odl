...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public void configureGlobalInstance(Component c, Object imp) {
        if (imp.equals(ConfigurationService.class)) {
            ...
            c.add(createServiceDependency().setService(IConnectionServiceInternal.class).setCallbacks("setConnectionServiceInternal",
                    "unsetConnectionServiceInternal").setRequired(true));
        }
